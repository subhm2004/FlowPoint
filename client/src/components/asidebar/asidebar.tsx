        ...
        <SidebarHeader className="!py-0 dark:bg-background">
          <div className="flex h-[50px] w-full items-center justify-start px-1">
            <Link
              ...
              className={cn(
                "flex min-w-0 items-center gap-2 font-semibold tracking-tight text-foreground hover:opacity-90",
                open ? "ml-1 text-sm md:text-base" : "justify-center"
              )}
              aria-label="FlowPilot home"
            >
              <FlowPilotLogo className={open ? "size-7" : "size-8"} />
              {open ? (
                <span className="truncate">FlowPilot</span>
              ) : null}
            </Link>
          </div>
        </SidebarHeader>
